...
//    }
    ...
    public static void newUserVerify(WebDriver driver, String newUser, String expectedNewUser){
        String locator="//td[.='" + newUser + "']";
        WebElement newUserNameCell= driver.findElement(By.xpath(locator));
//        String actualOrderDate=customerDateCell.getText();
//        Assert.assertEquals(actualOrderDate,expectedOrderDate);
        //or
        Assert.assertEquals(newUserNameCell.getText(),expectedNewUser);
    }
